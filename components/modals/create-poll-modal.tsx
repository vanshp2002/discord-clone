            ...
            <h2 className="text-lg font-semibold mb-4">Create Poll</h2> */}
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                        ...
                        <button type="button" onClick={handleAddOption} className="text-sm text-indigo-500 hover:text-indigo-400">
                            + Add Option
                        </button>
                    </div>
                    ...
                    <Button type="submit" className="px-4 py-2 bg-indigo-600 hover:bg-indigo-500 rounded text-white">
                        Create Poll
                    </Button>
                </form>
                {/* </div> */}
